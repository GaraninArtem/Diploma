...
<head>
    ...
    <title>EduBase | Главная</title>
</head>

<body>
    <div class="container-fluid p-0 m-0 d-flex" style="height: 100vh;">
        <!-- Боковое меню -->
    ...
    ';
        ...
        <div style="background-color: #f2fff3;" class="container-fluid p-0 m-0 col">
            <!-- Хедер -->
                    ...
                    <ul class="nav nav-pills ms-auto">
                        ...
                        <?php if (isset($_SESSION['login'])) {
                            ...
                            if ($user !== false) {
                                ...
                                <li><a href="#" class="nav-link" data-bs-toggle="modal" data-bs-target="#wysiwygModal">Написать
                                        пост</a></li>
                                ...
                                <li class="nav-item">
                                    <a href="#" class="btn nav-link" data-bs-toggle="modal"
                                        data-bs-target="#docModal">Документы</a>
                                </li>
                                <li class="nav-item">
            ...
            <!-- Стена -->
            <div class="overflow-container" style="max-height: calc(100vh - 72px); overflow-y: auto;">
                <?php
                if (isset($_SESSION['login'])) {
                    $userId = $_SESSION['login'];

                    $query = $connection->prepare("SELECT p.id, p.heading, p.content, p.create_dt, p.user_id, u.id as user_id, u.name, u.surname, u.img, u.status
        FROM post p
        ...
        ORDER BY p.create_dt DESC");
                    ...
                    <div style="background-color: #E1E8E5;" class="post rounded m-3 p-3">
                        ...
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <a href="post.php?id=' . $postId . '" type="button" class="btn2 btn btn-primary">К посту</a>
                            </div>
                        </div>
                    </div>
                </div>';
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" class="form-signin" id="loginForm">
                        ...
                        <button type="submit" id="login" name="login" class="btn2 btn btn-primary w-100" value="login"
                    ...
                    <div class="row">
                        <div class="col-6">
                            <p>Добро пожаловать в портал <strong style="color: #1f573f;">E</strong><strong
                                    style="color: #50BF8F;">du</strong><strong style="color: #1f573f;">B</strong><strong
                                    style="color: #50BF8F;">ase</strong>!</p>
                            <p>Для регистрации на этой платформе нужно иметь корпоративную почту, которую можно
                                запросить у ответственного лица. В ином случае данная учетная запись будет удалена.</p>
                        </div>
                        <div class="col-6">
                ...
                <div class="modal-body">
                    <form method="POST" class="form-wysiwyg">
                        <div class="container md">
                            <input class="form-control" type="text" name="heading" placeholder="Заголовок" required />
                            <br>
                            <div class="d-flex btn-group" role="group" aria-label="Basic example">
                                ...
                                <button class="spanspan btn btn-primary" onclick="execCmd(event, 'strikethrough')"><i
                                ...
                                <button class="spanspan btn btn-primary" onclick="formatBlock(event, 'h2')">H2</button>
                                <button class="spanspan btn btn-primary" onclick="formatBlock(event, 'h3')">H3</button>
                                <button class="span btn btn-primary" onclick="execCmd(event, 'insertHorizontalRule')"><i
